...
def renderings():
    ...
    with torch.no_grad():
        for test_cls in range(0, 16):
            test_dataset = SharpNetCompletionDataset(root="./shapenetcore_partanno_segmentation_benchmark_v0/", json_path="train_test_split/sgc_demos_in_paper.json", cls_=None, w=w)
